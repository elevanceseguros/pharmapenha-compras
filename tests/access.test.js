...
test('perfil financeiro só executa ações da agenda',()=>{assert.equal(canUseAction('finance','manual-payable'),true);assert.equal(canUseAction('finance','new-round'),false);assert.equal(canUseAction('finance','cloud-delete'),false)});
